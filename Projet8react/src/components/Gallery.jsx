...
const Gallery = ({ pictures }) => {
  ...
  const slideLeft = () => {
    //si l'index est égal à 0, on passe à la dernière image
  ...
  const slideRight = () => {
    //si l'index est égal à la dernière image, on passe à la première
    setCurrentIndex((prevIndex) =>
  ...
  // Vérifier si plus d'une image est présente avant d'afficher les flèches
